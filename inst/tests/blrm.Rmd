...
bcalpro <- blrm(calpro ~ endo, method='sampling', file='bcalpro.rds')
# Note: default method='both' but the optimizing part to get posterior modes did not work for this example
