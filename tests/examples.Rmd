...
# For some reason this takes several minutes under RStudio.  If so run:
...
## Data Dictionary
```{r ddict}
# results='asis' in the chunk header because html(contents) outputs
# html the old way
